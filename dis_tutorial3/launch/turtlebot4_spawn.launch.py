...
ARGUMENTS += [
    DeclareLaunchArgument('x', default_value='1.56', description='X coordinate of robot spawn'),
    DeclareLaunchArgument('y', default_value='-1.89', description='Y coordinate of robot spawn'),
    DeclareLaunchArgument('z', default_value='0.0', description='Z coordinate of robot spawn'),
    DeclareLaunchArgument('yaw', default_value='3.1416', description='Yaw (robot faces dock)')
]
...
def generate_launch_description():
    ...
    # Hardcoded dock position (new location)
    x_dock = '1.56'
    y_dock = '-1.89'
